package org.pickaid.pibrary.content.fastprojectileapi.render;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import org.pickaid.pibrary.config.FastProjectileAPIConfig;
import org.pickaid.pibrary.content.fastprojectileapi.entity.SimplifiedProjectile;
...
public record DoubleLayerLaserType(ResourceLocation inner, ResourceLocation outer, int color)
	...
	public void start(MultiBufferSource buffer, Iterable<Ins> list) {
		boolean ADDITIVE = FastProjectileAPIConfig.laserRenderAdditive.get();
		boolean INVERT = FastProjectileAPIConfig.laserRenderInverted.get();
		double tran = FastProjectileAPIConfig.getLaserTransparency();
