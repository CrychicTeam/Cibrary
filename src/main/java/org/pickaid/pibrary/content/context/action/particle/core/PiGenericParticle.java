...
public class PiGenericParticle extends TextureSheetParticle {

	private final PiParticleData data;

	private SpriteGeom geom = SpriteGeom.INSTANCE;

	@Nullable
	private PiOrientation orient;

	public PiGenericParticle(ClientLevel level, double x, double y, double z, double vx, double vy, double vz, PiParticleData data) {
	...
	public PiOrientation getOrientation() {
		return orient;
	}
