...
import org.pickaid.pibrary.api.fastprojectileapi.entity.BaseProjectile;
import org.pickaid.pibrary.api.fastprojectileapi.entity.ProjectileMovement;

import java.util.Objects;

public class Pirojectile extends BaseProjectile {
	private ProjectileData data;

	public Pirojectile(EntityType<? extends Pirojectile> pEntityType, Level pLevel) {
		super(pEntityType, pLevel);
	}

	public Pirojectile(EntityType<? extends Pirojectile> pEntityType, double pX, double pY, double pZ, Level pLevel) {
		this(pEntityType, pLevel);
		this.setPos(pX, pY, pZ);
	}

	public Pirojectile(EntityType<? extends Pirojectile> pEntityType, LivingEntity pShooter, Level pLevel) {
