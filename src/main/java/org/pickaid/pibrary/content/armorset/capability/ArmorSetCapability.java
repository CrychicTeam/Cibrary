package org.pickaid.pibrary.content.armorset.capability;
...
public class ArmorSetCapability {
    ...
    public static final ResourceLocation ARMOR_SET_CAPABILITY_ID = new ResourceLocation(Pibrary.MOD_ID, "armor_set");
