...
@Mod.EventBusSubscriber(modid = Pibrary.MOD_ID, value = Dist.CLIENT, bus = Mod.EventBusSubscriber.Bus.FORGE)
public class SoundManagerHandler {
    private static SoundManagerHandler instance;
    ...
    private SoundManagerHandler() {
    }

    public static SoundManagerHandler getInstance() {
        if (instance == null) {
            ...
            instance = new SoundManagerHandler();
        }
        return instance;
    }
