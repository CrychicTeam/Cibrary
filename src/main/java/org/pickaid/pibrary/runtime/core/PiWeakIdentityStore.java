...
/**
 * Weak-keyed identity store used for host- and owner-scoped runtime caches.
 *
 * @param <V> stored value type
 */
public final class PiWeakIdentityStore<V> {
    ...
    /**
     * Returns whether the store already contains a value for the given key.
     *
     * @param key identity key
    ...
    /**
     * Returns an existing value or computes and stores a new one atomically.
     *
     * @param key identity key
