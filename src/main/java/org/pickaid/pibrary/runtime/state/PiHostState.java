...
/**
 * Generic generated-state host that tracks dirty fields and provides full, filtered,
...
public final class PiHostState<S> {
    ...
    /**
     * Creates a host state from the generated schema for the given state type.
     *
    ...
    /**
     * Returns the schema id backing this host state.
     *
     * @return schema id
     */
