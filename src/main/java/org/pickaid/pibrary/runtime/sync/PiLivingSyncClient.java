...
/**
 * Clientbound sync packet consumer for generated living facets.
 */
@OnlyIn(Dist.CLIENT)
public final class PiLivingSyncClient {
    ...
    /**
     * Applies a living-facet sync packet immediately or queues it until the target entity exists.
     *
