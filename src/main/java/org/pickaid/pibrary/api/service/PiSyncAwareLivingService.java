...
/**
 * Optional lifecycle hook for services that need to react after sync payloads are applied.
 */
public interface PiSyncAwareLivingService {
    /**
     * Called after a sync payload has been decoded into the service state.
     *
