...
public final class CounterProjectileHooks {
    ...
    public static void bootstrap() {
        PiProjectileLifecycles.register(AbstractArrow.class, new org.pickaid.pibrary.api.projectile.PiProjectileLifecycleHandler<>() {
            @Override
            public void onJoinLevel(AbstractArrow projectile, PiProjectileLifecycleContext context) {
                onArrowJoinLevel(projectile, context);
            }
        });
        PiProjectileImpacts.register(AbstractArrow.class, new org.pickaid.pibrary.api.projectile.PiProjectileImpactHandler<>() {
            @Override
